...
def encoder_camera_neck_in_channels(first_out_indice = None):
    if first_out_indice is None:
        raise ValueError("Neck in channels requires encoder.camera.backbone.first_out_indice")
    in_channels = {
        0: [256, 512, 1024],
        1: [512, 1024, 2048]
    }
    return in_channels[first_out_indice]
